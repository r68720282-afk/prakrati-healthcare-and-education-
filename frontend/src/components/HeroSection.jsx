    ...
    <div className="grid lg:grid-cols-[42%_58%] items-center min-h-[650px]">
      ...
      <div className="px-8 lg:px-12 py-10">
        ...
        <p className="text-slate-600 text-xl leading-9 mb-8 max-w-xl">
          ...
          healthcare guidance, awareness programs, education support
        ...
        <div className="flex flex-wrap gap-4 mb-8">
          ...
          <a
            ...
            className="border-2 border-green-600 text-green-600 hover:bg-green-600 hover:text-white px-8 py-4 rounded-xl font-semibold"
          >
            WhatsApp
          </a>
          ...
          <a
            href="#query"
            className="bg-blue-900 hover:bg-blue-800 text-white px-8 py-4 rounded-xl font-semibold"
          >
            Submit Query
          </a>
